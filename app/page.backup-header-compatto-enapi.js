...
const heroHeaderStyle = {
  background:
    "linear-gradient(135deg, rgba(255,253,247,0.96) 0%, rgba(246,239,223,0.92) 55%, rgba(232,237,220,0.88) 100%)",
  border: `1px solid ${enapiColors.bordo}`,
  borderRadius: "24px",
  ...
  justifyContent: "space-between",
  gap: "12px",
  boxShadow: "0 10px 26px rgba(35, 75, 45, 0.08)",
  position: "relative",
  overflow: "hidden"
};
...
const logoStyle = {
  ...
  flexShrink: 0,
  border: `1px solid ${enapiColors.bordo}`,
  boxShadow: "0 6px 14px rgba(35, 75, 45, 0.10)"
};
