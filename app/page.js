      ...
      {authModalita !== "recupero" && (
        <div style={passwordFieldWrapStyle}>
          <input
            ...
            style={{ ...inputStyle, paddingRight: "104px" }}
          />
...
<div style={cardStyle}>
  <div style={risorseHeroStyle}>
    <div>
      ...
      <h2 style={pesauroTitleStyle}>Biblioteca ENAPI</h2>
      <p style={pesauroSubtitleStyle}>
        Documenti, studi, grafiche, social e prodotti utili raccolti in uno spazio
        ordinato e sempre consultabile.
      </p>
    ...
    <div style={risorseHeroIconStyle}>
      <img
        src="/icons/icon-risorse.png"
        alt="Risorse ENAPI"
        style={risorseHeroImageStyle}
      />
    </div>
  </div>
</div>
...
const heroTitleStyle = {
  margin: 0,
  color: "#fffaf0",
  fontSize: "clamp(22px, 4.4vw, 31px)",
  lineHeight: "1",
  fontWeight: "700",
...
const adminResourceHeaderStyle = {
  display: "flex",
  justifyContent: "space-between",
  alignItems: "flex-start",
  gap: "12px",
...
const adminResourceNoteStyle = {
  ...
  border: `1px dashed ${enapiColors.oliva}`,
  borderRadius: "16px",
  padding: "12px",
  color: enapiColors.marrone,
  fontSize: "14px",
...
const resourceTypeStyle = {
  color: enapiColors.oliva,
  backgroundColor: "rgba(232,237,220,0.78)",
  border: `1px solid ${enapiColors.bordo}`,
  borderRadius: "999px",
  padding: "6px 10px",
  fontWeight: "800",
